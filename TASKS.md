...
**Active bounded objective:** Publish the narrow zero-token carrier correction as Attempt 5 of the frozen `holostate-v1-warm-trajectory-related-task-evaluation-v1`, preserving Attempt-4 terminal evidence and every scientific request, seed, route, evaluator, decision law, and resource law.
**Next exact action:** Publish the Attempt-5 runtime repair, then execute the already authorized `holostate-v1-warm-trajectory-related-task-evaluation-v1-attempt-5` once with one fresh external authority bound to the repair commit.
...
- [ ] Publish the Attempt-5 zero-token repair and execute the explicitly authorized fresh Attempt 5 once. Preserve every outcome; do not publish a scientific result or begin a follow-on automatically.
