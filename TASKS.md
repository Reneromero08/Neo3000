...
- [ ] Execute the already authorized `holostate-v1-warm-trajectory-related-task-evaluation-v1-attempt-2` exactly once from the final pushed repair commit with one fresh external authority. Preserve all outcomes and do not publish or begin a follow-on automatically.
