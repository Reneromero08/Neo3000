...
**Active bounded objective:** Publish the exact streamed carrier-accounting and postflight identity corrections as Attempt 6 of the frozen `holostate-v1-warm-trajectory-related-task-evaluation-v1`, preserving Attempt-5 terminal evidence and every scientific request, seed, route, evaluator, decision law, and resource law.
**Next exact action:** Publish the Attempt-6 controller repair, then execute the already authorized `holostate-v1-warm-trajectory-related-task-evaluation-v1-attempt-6` once with one fresh external authority bound to the repair commit.
...
- [ ] Publish the Attempt-6 controller repair and execute the explicitly authorized fresh Attempt 6 once. Preserve every outcome; do not publish a scientific result or begin a follow-on automatically.
