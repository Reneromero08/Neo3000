...
**Active bounded objective:** Binding-1 r3 and binding-2 r1 each completed once as `BALANCED_OPAQUE_RANK_HEAD_V2_VISIBLE` under the same frozen rank-head v2 mechanism and independently keyed private bindings. Both deterministically selected rank zero before private mapping, matched their own private singleton, scored `5/5`, and restored cleanly. Canonical split records `neo-exp-0040` and `neo-exp-0041` are published at lines 53 and 54 with SHA-256 values `0B167E49C9CA83BD57893B792CA729E0F33F154E27B0CEDD4B172110FCB75C16` and `D6DF5C9B4FFF825F236AB616EE8292CEAEC8F9905E9C47CF57B29F70F68F87EE`. Static adjudication artifact `9473E1052DBE72CEABCB70EBA7787266DDF350843F01774A3F363213F29D4961` supports only `END_TO_END_CROSS_BINDING_REPLICATION` and `DETERMINISTIC_RANK_HEAD_EXTRACTION_REPLICATED_ACROSS_TWO_PRIVATE_BINDINGS`.
**Next exact action:** `Design the minimum cross-binding causal test required to determine whether parent dependence replicates under binding-2, without rerunning either completed full-information experiment.` Binding-2 parent dependence, causal replication across bindings, general two-parent necessity, transfer, general catalytic inference, task advantage, superiority, SOTA, broader/restart HoloState, Deep, and automatic promotion remain locked.
...
- [ ] Design the minimum cross-binding causal test required to determine whether parent dependence replicates under binding-2, without rerunning either completed full-information experiment.
