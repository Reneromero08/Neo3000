...
- [ ] Execute CS1-v2 only under future separate exact-main and model authorization; task advantage, SOTA, broader process-local HoloState, restart persistence, and automatic promotion remain locked.
