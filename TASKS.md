...
- [x] Prepare Attempt 5 with the smallest runtime correction: honor `n_predict=0` immediately after prompt evaluation and before next-token sampling, with zero-denominator timing guards. Build candidate CUDA server SHA-256 `1166D5650C9BD9ACDD4C94EC5E1C72454F22CDC8C71035CAA0FBC450E95D5E00`; pass the real-model live regression with `9` prompt tokens, `0` generated tokens, empty content/tokens, and stop type `limit`; bind all Attempt-4 evidence. Preregistration artifact/file are `ACB19F0360E6EECFF2C858E7FFC2FDD9D8637CFCE775D41AA8B51FDCE07C75CD` / `597D4C66D4DF0829F715DA93F0CDD80239AA19C5127A08119F4DEA6F48668356`; controller, frozen scientific, scorer, and resource bindings remain unchanged; focused warm tests pass `39/39`.
