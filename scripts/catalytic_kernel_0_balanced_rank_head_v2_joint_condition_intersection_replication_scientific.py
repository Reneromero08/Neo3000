#!/usr/bin/env python3
"""Frozen model-contact surface for the four-request joint-condition-intersection probe.
...
class ScientificSurfaceError(ValueError):
    """The frozen joint-condition-intersection execution surface changed or is unsafe."""


DESIGN_ID = "balanced-opaque-transform-only-joint-condition-intersection-replication-v1"
REQUEST_IDS = ("R0-AB", "R0-BA", "R1-AB", "R1-BA")
MAXIMUM_MODEL_GENERATIONS_PER_REQUEST = 1
MAXIMUM_TOTAL_MODEL_GENERATIONS = 4
CAPTURE_SCHEMA_VERSION = 1
CAPTURE_HMAC_DOMAIN = b"ck0-rank-head-v2/joint-condition-intersection-replication/capture-hmac-v1\0"
...
def frozen_scientific_binding(
    ...
    *,
    ...
    body = {
        "surface_version": 1,
        "module": {
            "path": "scripts/catalytic_kernel_0_balanced_rank_head_v2_joint_condition_intersection_replication_scientific.py",
