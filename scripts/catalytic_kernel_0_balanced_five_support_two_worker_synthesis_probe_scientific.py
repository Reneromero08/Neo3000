#!/usr/bin/env python3
"""Frozen model-contact surface for the five-support worker-synthesis probe."""
...
class ScientificSurfaceError(ValueError):
    """The frozen worker-synthesis execution surface changed or is unsafe."""


DESIGN_ID = "balanced-opaque-five-support-two-worker-synthesis-probe-v1"
REQUEST_IDS = ("worker-A", "worker-B", "synthesis-AB")
MAXIMUM_MODEL_GENERATIONS_PER_REQUEST = 1
MAXIMUM_TOTAL_MODEL_GENERATIONS = 3
CAPTURE_SCHEMA_VERSION = 1
CAPTURE_HMAC_DOMAIN = b"ck0/five-support-two-worker-synthesis/capture-hmac-v1\0"
...
_CONTRACT_FIELDS = {
    ...
    "frozen_profile_commitment_sha256",
    "worker_shard_commitments",
    "worker_support_commitments",
    "unique_intersection_commitment_sha256",
    "worker_seed",
    "synthesis_seed",
    "model_sha256",
    "binary_sha256",
    "synthesis_carrier_root_sha256",
...
def frozen_scientific_binding(
    ...
    *,
    ...
    _require(
        ...
        and contract.get("maximum_total_model_generations") == 3,
    ...
    body = {
        "surface_version": 1,
        "module": {
            "path": "scripts/catalytic_kernel_0_balanced_five_support_two_worker_synthesis_probe_scientific.py",
        ...
        "three_generations_maximum_overall": True,
