...
class ReadinessTests(unittest.TestCase):
    def test_long_model_load_does_not_query_listeners_in_poll_loop(self) -> None:
        ...
        result = readiness.wait_for_holostate_readiness(
            ...
            sidecar_health_ok=lambda: sidecar_health.popleft(),
        ...
        self.assertEqual(qualifier_calls, [(9292, frozenset({32684})), (9494, frozenset({37804}))])
    ...
    def test_listener_unavailability_is_not_misreported_as_empty_pid_set(self) -> None:
        ...
        with self.assertRaisesRegex(readiness.HoloStateReadinessError, "stable-listener-query-unavailable"):
            readiness.wait_for_holostate_readiness(
                sidecar_pid=37804,
                stable_pids={32684},
                stable_port=9292,
