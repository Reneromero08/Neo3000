#!/usr/bin/env python3
"""Frozen model-contact surface for the six-request three-parent global-invariant probe.
...
class ScientificSurfaceError(ValueError):
    """The frozen three-parent-global-invariant execution surface changed or is unsafe."""


DESIGN_ID = "balanced-opaque-transform-only-three-parent-global-invariant-probe-v1"
REQUEST_IDS = ("T0-ABC", "T0-BCA", "T0-CAB", "T1-ABC", "T1-BCA", "T1-CAB")
MAXIMUM_MODEL_GENERATIONS_PER_REQUEST = 1
MAXIMUM_TOTAL_MODEL_GENERATIONS = 6
CAPTURE_SCHEMA_VERSION = 1
CAPTURE_HMAC_DOMAIN = b"ck0-rank-head-v2/three-parent-global-invariant-probe/capture-hmac-v1\0"
...
def frozen_scientific_binding(
    ...
    *,
    ...
    """Bind the exact six requests and their immutable contact implementation."""
    ...
    body = {
        "surface_version": 1,
        "module": {
            "path": "scripts/catalytic_kernel_0_balanced_rank_head_v2_three_parent_global_invariant_probe_scientific.py",
        ...
        "six_generations_maximum_overall": True,
