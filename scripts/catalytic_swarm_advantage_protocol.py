...
EXPECTED_CONTRACT_SHA256 = "fe455e7b049f4fb0b1ab1a13899e3da18b4b2bbec824a664a38599d0a4fd2a3e"
SCHEMA_VERSION = 1
ATTEMPT_VERSION = 1
...
def validate_catalytic_swarm_1_contract(value: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if contract_sha256(value) != EXPECTED_CONTRACT_SHA256:
        raise AdvantageProtocolError("CatalyticSwarm-1 contract hash drifted")
