...
Attempt 5 changes only the demonstrated runtime defect: after prompt evaluation, `n_predict=0` now completes before sampling, while zero-count timing denominators remain defined. The CUDA candidate binary is `1166D5650C9BD9ACDD4C94EC5E1C72454F22CDC8C71035CAA0FBC450E95D5E00`; a real-model live regression reports `9` prompt tokens, `0` generated tokens, empty output, and stop type `limit`. Preregistration artifact/file are `ACB19F0360E6EECFF2C858E7FFC2FDD9D8637CFCE775D41AA8B51FDCE07C75CD` / `597D4C66D4DF0829F715DA93F0CDD80239AA19C5127A08119F4DEA6F48668356`; controller, frozen scientific, scorer, and resource bindings are unchanged.
