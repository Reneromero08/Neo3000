...
## Checkpoint 2: Binding-2 parent-dependence forensic recovery

**Status:** ORIGINAL TERMINAL `INCONCLUSIVE` PRESERVED / CONTROLLER-LOCK FALSE NEGATIVE PROVEN / ZERO-CONTACT CAPTURE REPLAY / PARENT-A DIRECTIONAL REPLICATION ONLY / BROADER CLAIMS LOCKED
...
- [x] Publish separate canonical forensic artifact `lab/ck0_balanced_opaque_rank_head_v2_binding_2_parent_dependence_forensic_recovery_1.json`, SHA-256 `110DAE908E4C1F01747C2CBBEA9F3A34BB2ACA61397D55B0648D82453A3DD975`. Support only directional Parent-A information dependence replicated across the two private bindings; disclose no alias, ranking, map, root, raw response, raw exception, or cross-binding correspondence.
...
**Next exact action:** preserve this narrow directional-A recovery. Do not retry either consumed arm. Any future independent causal experiment requires a separately authorized static design and fresh authority.
