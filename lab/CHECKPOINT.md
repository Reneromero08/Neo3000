...
- [x] Prepare Attempt 5 with the narrow runtime repair that completes `n_predict=0` after prompt evaluation but before sampling, plus defined zero-count timing metrics. Candidate CUDA binary SHA-256 is `1166D5650C9BD9ACDD4C94EC5E1C72454F22CDC8C71035CAA0FBC450E95D5E00`; the real-model focused regression passes with `9` prompt tokens and `0` generated tokens. Bind Attempt-4 custody; preserve all scientific requests, seeds, routes, scorer, decision, and resource laws. Preregistration artifact/file are `ACB19F0360E6EECFF2C858E7FFC2FDD9D8637CFCE775D41AA8B51FDCE07C75CD` / `597D4C66D4DF0829F715DA93F0CDD80239AA19C5127A08119F4DEA6F48668356`; focused warm tests `39/39`.
