...
## Checkpoint 2: Runtime-native executable carrier boundary selected

**Status:** PUBLISHED INHERITED-CARRIER RESULT PRESERVED / RUNTIME-NATIVE EXECUTABLE BOUNDARY SELECTED / SAME-PANEL LINE RETIRED / ZERO MODEL CONTACT / BROADER CLAIMS LOCKED
...
- [ ] Prepare `PREPARE_MULTI_BRANCH_RUNTIME_NATIVE_CARRIER_EVALUATION`: one held-out multi-branch runtime-native carrier evaluation with authenticated exact-token strict extensions, a process-local RAM or full-state root for branch isolation, direct controls, actual fresh-token accounting, and separately measured closure. Keep complete lifecycle, exact restoration, general catalytic inference, transfer, restart persistence, superiority, SOTA, and promotion locked.
