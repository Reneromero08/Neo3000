...
## Checkpoint 2: Binding-2 parent-dependence causal replay safely resumable

**Status:** STATIC TWO-ARM REPLAY IMPLEMENTED / RESTART-SAFE / PREREGISTERED / ZERO NEW AUTHORITY OR LIVE ACTIVITY / BROADER CLAIMS LOCKED
...
- [x] Bind one generic two-arm external authority, exact protected commit and source custody, one generation maximum per arm, per-arm `request-started` consumption, one physical slot and sidecar epoch, capture-before-parse, replay without model contact, no retry after uncertain dispatch, and both rank heads frozen before either private mapping. Authority-object schema SHA-256 is `D59C7D3789BBC780E1F2337C0C92A39D96006429110DF1CCF14F23C14CE0B56D`; receipt schema SHA-256 is `63EB95CCACB8760F68FC02C142C9D47BF0934A217C7C26FC8EC87B7F042468F3`.
...
- [x] Bind repaired implementation SHA-256 `EB4B567D790FC5E032DBA7E9BC822252CC9B3CB8C99F177C04FC4A81BD804A9D`, preregistration artifact SHA-256 `46D7645670754BC8A2B82DA9922FCE4A8213BF81BB2BCD2FF9DF5171CCE8F334`, and canonical document SHA-256 `FEAA1CAAD34AC027ADA0C10B273C9A8AD48D370E0DC1B76209B74304B0E39B7C`. Preserve authority object/receipt schemas `D59C7D3789BBC780E1F2337C0C92A39D96006429110DF1CCF14F23C14CE0B56D` / `63EB95CCACB8760F68FC02C142C9D47BF0934A217C7C26FC8EC87B7F042468F3`, arm request hashes `260F18D1C143C5D61ED775BB85F297D0A96E1507451347BED517BDAEDEE701A8` / `2B1124B9D63BC6AF4BF22D25D30606034F26466EEAFB8CF9081ECCC7C242395E`, and zero new authority, receipt, runtime root, journal, capture, archive, sidecar, model request, or scientific result.
- [x] Pass focused replay 36 / 36, all rank-head-v2 156 / 156, balanced compatibility 16 / 16, historical binding-2 16 / 16, CK0 12 / 12, runtime 10 / 10, changed-file compilation, exact preregistration reconstruction, canonical JSON/JSONL parsing, tracked-private/no-smuggle scans, evaluator gates, and protected preflight. The one complete CPU discovery ran 995 tests: 993 passed in the sandbox, and only the two known Windows runtime-identity file-lock tests required their exact host-permission rerun, which passed 2 / 2. Semantic failures are zero.
...
**Next exact action:** `After the resumability-repair commit publishes, separately authorize ck0-balanced-v2-rank-head-b2-parent-dependence-r1 with one fresh external authority ID bound to the exact published repair commit and canonical preregistration.`
