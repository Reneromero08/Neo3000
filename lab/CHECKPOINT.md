...
**Next exact action:** `REPAIR_VALIDATE_AND_EXECUTE_NEO_EXP_0061_CONTROLLED_RUNTIME_IDENTITY_LOCK_BINDING`. Repair only the controlled-readiness identity path-lock binding in the discovery sidecar, add focused tests, preserve all water-panel scientific controls, execute the still-active preregistered `neo-exp-0061` under standing frontier authority, adjudicate and record it, advance the cursor, and continue the autonomous goal run.
