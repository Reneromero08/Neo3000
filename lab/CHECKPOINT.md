...
## Checkpoint 2: Binding-2 parent-dependence causal replay prepared

**Status:** STATIC TWO-ARM REPLAY IMPLEMENTED / PREREGISTERED / ZERO NEW AUTHORITY OR LIVE ACTIVITY / BROADER CLAIMS LOCKED
...
- [x] Bind implementation SHA-256 `62E347A843C1F1D2AA29108521520572C347EFBFB4E5849B52D4B2E9CC8B5A03`, preregistration artifact SHA-256 `57D9EA54E5E5D5E9571B7620842A29D32601E5892468C2DEA522152F328F552C`, and canonical document SHA-256 `32FF05740581BD16233675A6E4D6EAA74C5059F846D24415B69F92C07FB96EAA`. Preserve zero new authority, receipt, runtime root, journal, capture, archive, sidecar, model request, or scientific result.
- [x] Pass focused replay 27 / 27, all rank-head-v2 147 / 147, balanced compatibility 16 / 16, historical binding-2 16 / 16, CK0 12 / 12, runtime 11 / 11, evaluator 28 / 28, changed-file compilation, exact preregistration reconstruction, canonical JSON/JSONL parsing, tracked-private-byte scans, and two final read-only affected-scope audits. The one completed CPU discovery ran 984 tests: 982 passed in the sandbox and only the two known Windows runtime-identity file-lock tests required exact host-permission reruns, which passed 2 / 2; semantic failures are zero. The sandbox preflight attempt stopped only on candidate-worktree ownership before repository gates; the exact read-only host-qualified preflight then passed with protected main `720b434d1e2a6e54754d305aed89289cf707c545`, clean candidate `14de9c71593e5aea4fcfcadeda47ba5c623fadcf`, current evaluator lock, healthy stable service, and free sidecar port.
...
**Next exact action:** `After the preparation commit publishes, separately authorize ck0-balanced-v2-rank-head-b2-parent-dependence-r1 with one fresh external authority ID bound to the exact published preparation commit and canonical preregistration.`
