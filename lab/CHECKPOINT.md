...
**Next exact action:** `AUTHORIZE_ONE_LIVE_INHERITED_TASK_A_CARRIER_EVALUATION`. Bind one fresh external authority to the final protected preparation commit; do not execute automatically.
