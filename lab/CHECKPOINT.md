...
- The static successor for planned `neo-exp-0061` selects the pinned worker-v4 readiness-control object at canonical SHA-256 `3A7CD00D378A03325ED83F31CB4F211C50D3FF2242FF9684FD71955C97E63626`, passes its absolute 180-second deadline and exact prelaunch ownership evidence, and makes the bounded `15` second / `3` consecutive-success startup recovery reachable. Recovery remains unavailable after admission.
- This also activates stronger fail-closed startup evidence: exact prelaunch stable/empty-sidecar ownership, stable PID/listener checks during load, exact stable and sidecar listener admission, and stable-listener reconfirmation. It changes no model-facing panel, token, seed, sampler, checkpoint, evaluator, cache, or carrier behavior.
- Water controller/test identities are `3AB1D1F589A6F0029C412BA028E622B29320C8389E71A0CBCAFCA57671FF891A` / `8832638E410C4D2820098188185D29C9C2802334CADFF2967867FC8F73DA96D5`. Validation passes 6/6 water, 6/6 inherited panel, 19/19 readiness, and 62/62 frontier tests. Independent re-audit clears the prior inert-policy blocker. Static preparation launched no process and contacted no model, server, or stable endpoint.
