...
## Checkpoint 2: Binding-2 full-information one-shot observed

**Status:** EXECUTED ONCE / `BALANCED_OPAQUE_RELATIONAL_COLLAPSED` / SAFE TERMINAL CLOSURE / EXTERNAL AUTHORITY CONSUMED / NO RETRY / STATIC EVIDENCE PUBLICATION

- [x] Admit exact protected `main` `1eb4227219c78209ba487ab68339772887018722`, matching local/remote refs, clean stable and candidate custody, candidate `14de9c71593e5aea4fcfcadeda47ba5c623fadcf`, exact model/binary/carrier/schema/preregistration/implementation identities, historical CIB0/CK0 and binding-1 evidence, adjudication, both private roots, 14 / 14 independence gates, healthy stable PID `20388`, and free port 9494.
- [x] Consume exactly one external authority immediately before the first runtime mutation. Authority-ID hash `1E2261AA8D0FA1CC0C6A371F5EA7AAAB0DA60FEB9BE30487F6D5EB7AB063CAF8`, receipt HMAC `6CA384671222D9875E63C6EE4E3090772CD67E409E09633D3D6AE104FF6DBE54`, and receipt SHA-256 `FEDEF50312E6F0A6326C67BB4B57ED295C2E5390E775B1FC3CED4C4942BD5878` bind the exact run, profile, full-information mode, protected commit, preregistration, implementation, model, binary, carrier root, and run-key commitment. Maximum invocations was one; retry and automatic follow-on were false.
- [x] Complete all six requests with accepted transport and exact cache admission. Both complete five-member parent relations reached transform unchanged. `reconcile` produced a three-entry opaque ranking with commitment `02C6897B8EEDE8559A4A9F6F0E6A3B4D3DF27DE08648F9F5A5A0996D4C1711A2`; its top matched the private singleton. Independently, extraction commitment `58AA561B8D8C3CC23F38749FFFAEC8A308E8029EEFD07CDF92E8B5E6F44AF3FF` did not select the singleton; private public score was `3 / 5`.
- [x] Classify only `BALANCED_OPAQUE_RELATIONAL_COLLAPSED`. No failure occurred; process exit was `0`; observed command wall time was `482.9` seconds. This result does not replicate the binding-1 visible result and unlocks no scientific claim.
- [x] Pass restoration, cleanup, stable/candidate custody, historical custody, zero active leases, six total leases, maximum concurrency one, sidecar retirement, runtime removal, run-lock removal, and port release. Stable PID remained `20388`; sidecar PID was `4112`. No measured resource-ceiling breach occurred. WDDM telemetry was unavailable and advisory, so no WDDM or GPU-memory peak is claimed.
- [x] Bind manifest `1E330CCFB2727E3273F298D976641E4DE4CEAD1C335FE48519025E760CB6B70F`, result `17B5E36EDC0261B8D98D25F5F4F9E4884F86F6982C8F4D51EA3E54AAE90A88E5`, closure `24676B5E148E545BFF3339187C651791C2BC47273452F4705802AC515B95C06D`, and restoration receipt `005115225A5FED24894FF423C6B51B0762B1584924C2E88CE63C6C3E2840B74E`. Preserve the ignored runtime evidence and consumed authority receipt.
- [x] Preserve bounded metadata only. The raw authority ID did not enter the consumed receipt, runtime evidence, tracked files, or model-visible payloads. Raw SSE, model response text, reasoning, private mapping, run key, hidden data, and cross-binding correspondence remain untracked and undisclosed.
- [x] Qualify token evidence exactly: all six verbose generated-token-array observations were unavailable; `completion_token_count_match` was `false`; requests were accepted using authoritative completion usage plus source-bound terminal-EOS evidence; complete generated-token-array confirmation was unavailable.
- [x] Publish only these validated bounded evidence changes in this separately authorized static operation. Do not rerun the full-information command and do not authorize or execute either deletion control.

**Next exact action:** after the authorized publication-guard incorporation and state-independent test hardening complete, separately authorize only a static scientific adjudication. Both binding-2 deletion controls remain reserved-unconsumed and unauthorized. Cross-binding replication, general two-parent necessity, transfer, general catalytic inference, task advantage, superiority, SOTA, broader/restart HoloState, Deep, and automatic promotion remain locked.
