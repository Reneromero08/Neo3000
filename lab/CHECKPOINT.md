...
## Checkpoint 2: Binding-2 parent-dependence causal replay bounded-controller-repair resumable

**Status:** STATIC TWO-ARM REPLAY IMPLEMENTED / FROZEN SCIENTIFIC SURFACE / BOUNDED DESCENDANT CONTROLLER REPAIR / PREREGISTERED / ZERO NEW AUTHORITY OR LIVE ACTIVITY / BROADER CLAIMS LOCKED
...
**Next exact action:** `After this bounded-controller-repair commit publishes, separately authorize ck0-balanced-v2-rank-head-b2-parent-dependence-r1 with one fresh external authority ID bound to the exact published commit and canonical preregistration.`
