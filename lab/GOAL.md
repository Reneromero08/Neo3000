...
## Checkpoint 2: Within-binding position-seed causal panel statically preregistered

The audit's unexecuted `two private bindings × two seeds × three arms` recommendation is superseded because it confounded singleton presentation position with private-binding identity, alias mapping, lexical identity, and commitment token sequence. Historical diagnostics and artifact bytes remain unchanged. The minimum replacement is `balanced-opaque-transform-only-within-binding-position-seed-crossover-v1`: one fresh private binding × two controlled presentation orders × two fixed seeds × three transform-only arms, exactly 12 future generations.

The private binding was selected before outcomes by first eligible domain-separated counter under one secure private selection seed and ceiling 4,096. Counter `49` is the first match after 50 attempts; the private singleton is at predeclared central global lexical ordinal 33, every opaque symbol is three tokenizer IDs, and both five-member supports are exact. Public commitments are selection seed `0D6042BF50265BFC21525E5AF5F4420A6842AB6373FED3F593C7B1B3D91884F2`, private root `F449FB16F15F65AC0C6EAC05F3DC63EC75462D381E0B029DF0E2363B52B6CC5C`, profile binding `0E55293C3E08DFE8EE56C2DE6DA32CB89B8170E753D0C809E89E99908A51F334`, and alias map `6384655F0C64BED3C0F63E011FA1BAF4B7007C30DDB80DE38995B744CF047274`. No root, alias, mapping, or rejected candidate is tracked.

Canonical semantic-set commitments are Parent-0 `2336A959827451E2BCBE7904D703554BA607DD295C4358E9C3580EF2C4E7ADDA` and Parent-1 `CD7E7483664E973593F1D62FC05A079B97AE64E7F83601CFF4839E46B5B212D4`. P0 privately places the singleton first and P1 last; the other four use public lexical order. The projections retain identical support, fields, commitments, 232-byte serialization, and tokenizer lengths: Parent-0 `120/120`, Parent-1 `123/123`. Only list order and its exact token-sequence/request commitment differ. Model-visible labels disclose no condition or winner.

Seeds are exactly S0 `1851550238` and S1 `1669860413`; every P×S cell contains `full-information`, `delete-parent-0`, and `delete-parent-1` under the same cell seed. All 12 requests are stateless transform-only requests. The frozen scientific execution binding is `621F167BF0A0F7EFB6F6AD1A81DC59E9B71978FF466C4FE09D765B90B24F23DA`; repairable controller binding is `1BF04B8BA4BACD08C8D139CEFD75B6D742C86AF634818EF879EB53711864F2BA`; combined implementation is `3D615D149CB769682AF2F4BE516A388B62BB0A86776760145B437B2A59686177`. Authority object, receipt, capture, and journal schema hashes are `6D94934091DFD06C16ADF2E25A36BA073E325BB068246497FFABB5ACA2B4071F`, `060D8C278195B05507BC02C9646F6CF9E1B8A7CA3D9AFF27D5598C56F01373A3`, `994ABF86EAB7407E1A2E05DA68308C178094A13AEC24EE5DB0F4F344B6DC6052`, and `98776A1A75AA758242E1B09F584225C33031762698FF07710AEA8AAABBF59D4E`.

Canonical preregistration artifact `lab/ck0_balanced_opaque_rank_head_v2_position_seed_crossover_1.json` has byte SHA-256 `6F37F858271CF3F5A10CA8CADEC6D03E7E7068347E5603D67B52C25813697E6D` and canonical document SHA-256 `1B1D2F260C94D87876961F5B9AB592B28560B94B8E87B4A3C8B02814D5404FA3`. Static qualification passes crossover `24/24`, all rank-head-v2 `192/192`, forensic `6/6`, asymmetry `8/8`, evaluator `28/28`, exact reconstruction, compilation, canonical/private scans, protected preflight, and the one 1,039-test CPU discovery with 1,037 sandbox passes plus the two known Windows file-lock cases passing `2/2` under host permission. No authority, sidecar, model request, live execution, result, or retry exists.

The original terminal result/archive, both captures, forensic recovery, private asymmetry audit, supported shared-endpoint claim, and its qualifier remain unchanged. Parent-B dependence, bilateral dependence, general two-parent necessity, cross-binding causal replication, transfer, general catalytic inference, advantage, superiority, SOTA, broader/restart HoloState, Deep, and automatic promotion remain locked.

**Next exact action:** separately authorize one live execution with a fresh external authority ID bound to the exact published static commit and preregistration artifact SHA-256 `6F37F858271CF3F5A10CA8CADEC6D03E7E7068347E5603D67B52C25813697E6D`.
