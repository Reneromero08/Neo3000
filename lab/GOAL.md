...
`balanced-opaque-transform-only-within-binding-position-seed-crossover-v1` executed exactly once from protected main `27a5188d1aae8fb0944875865a44cb4583fd0352`. It consumed one authority, completed all 12 one-generation transform requests without retry, preserved 12 authenticated captures and 52 authenticated journal events, passed cleanup/postflight, and created no automatic follow-on. Receipt, manifest, result, closure, journal, journal-head, and 17-file archive hashes are `7EE9A98A78100E6675A659A861D899E0AE95FD2FAF65D87449F28EC9BDE804A7`, `C47B16C6F6E6C8EFFE42F5AB7EDD5DC65ED5A327DCC9BD2E96FAB06105DF86EC`, `008D4FEFE24D6CB4A846A76E832A892BCBBF134F1A1C951FCDA55F0624C0E0FB`, `60077B27F2FFAE7FBC02B7FB7B8EC0B803F9086716611A84C88CD4F6AC8D633D`, `1BB6E91E9D9E0E767E78D13C19FFCE3F952166A5A914DA2EBB9394E00A2F3100`, `F6A0CC59A696D818FCFDF5357AB5534F1BD35377C6AB36B870DDC2AACCD7F2FA`, and `BC9404292F54F5597E0D7BA3AEBC83EF6A95E9C19708164994D515980AEB6B1B`.

Zero-contact replay exactly reproduces the terminal matrix. At P0 singleton-first, full information and both single-parent deletions recover the singleton at `5/5` under S0 and S1. At P1 singleton-last, full information recovers it at `5/5`, while deleting either parent prevents recovery at `3/5` under both seeds. No seed interaction is observed.

The panel supports `SINGLETON_PRESENTATION_POSITION_EFFECT_SUPPORTED`, `PARENT_INFORMATION_DEPENDENCE_IS_SINGLETON_PRESENTATION_POSITION_CONDITIONAL_WITHIN_MATCHED_BINDING`, and `JOINT_PARENT_INFORMATION_OVERCOMES_UNFAVORABLE_SINGLETON_PRESENTATION_POSITION_ACROSS_TWO_FIXED_SEEDS`. `PARENT_A_ONLY_DIRECTIONAL_ASYMMETRY` is retired as a stable explanation; its historical evidence remains preserved but is now interpreted as presentation-confounded. This panel tests the transform causal core under one matched private binding, not a complete new borrow -> transform -> extract -> restore cycle.

Canonical adjudication artifact `lab/ck0_balanced_opaque_rank_head_v2_position_seed_crossover_adjudication_1.json` has SHA-256 `DD829AE6C4F38EDA325462AD24D030AA7DF3E74FC69D54C80DE1F9996C820B53`. Canonical result record `neo-exp-0042` is at `lab/results.jsonl:55` with SHA-256 `DAF072E43700F71A76537843507C578FEA38679AA15DC9A0C783090B29D5D0E8`.

Bounded static qualification passes exact archive/capture verification and zero-contact replay, adjudication reconstruction and publication validation, focused publication `7/7`, evaluator `28/28`, changed-file compilation, 19 scientific JSON documents and 55 JSONL records, private/no-smuggle scans, regenerated evaluator lock, and protected preflight. No complete CPU suite was run because no executed runtime source changed.

Position-independent bilateral dependence, general two-parent necessity, cross-binding generalization of this crossover, transfer, general catalytic inference, task advantage, superiority, SOTA, broader or restart-persistent HoloState, Deep, and automatic promotion remain locked.
