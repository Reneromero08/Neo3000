...
## Checkpoint 2: Publish and harden consumed binding-2 collapsed evidence

Run `ck0-balanced-v1b2-full-r1` executed exactly once from protected main `1eb4227219c78209ba487ab68339772887018722` under the external one-shot authority bridge. The authority was atomically consumed immediately before the first live mutation and remains permanently consumed. Its bounded authority-ID hash is `1E2261AA8D0FA1CC0C6A371F5EA7AAAB0DA60FEB9BE30487F6D5EB7AB063CAF8`; receipt HMAC is `6CA384671222D9875E63C6EE4E3090772CD67E409E09633D3D6AE104FF6DBE54`; receipt SHA-256 is `FEDEF50312E6F0A6326C67BB4B57ED295C2E5390E775B1FC3CED4C4942BD5878`. The raw authority ID did not enter the consumed receipt, runtime evidence, tracked files, or model-visible payloads.

All six model requests completed and were accepted. Borrow warmed the exact immutable root; both branches produced complete five-member opaque support relations; transform received both relations unchanged and used `reconcile`. Its three-entry ranking placed the private singleton first. Independently, extraction selected a different alias whose private public score was `3 / 5`, so the exact terminal classification is `BALANCED_OPAQUE_RELATIONAL_COLLAPSED`, not visible replication. All six verbose generated-token-array observations were unavailable; `completion_token_count_match` was `false`; requests were accepted using authoritative completion usage plus source-bound terminal-EOS evidence; complete generated-token-array confirmation was unavailable. Process exit was `0`; no failure, retry, repair, resampling, deletion control, or automatic follow-on occurred.

Restoration, cleanup, stable/candidate custody, historical CIB0/CK0 custody, private custody, zero active leases, six total leases, maximum concurrency one, sidecar retirement, runtime removal, run-lock removal, and port release all passed. Stable PID `20388` was preserved; sidecar PID was `4112`. No measured resource-ceiling breach occurred. WDDM telemetry was unavailable and advisory, so no WDDM or GPU-memory peak is claimed. Evidence is bound by manifest `1E330CCFB2727E3273F298D976641E4DE4CEAD1C335FE48519025E760CB6B70F`, result `17B5E36EDC0261B8D98D25F5F4F9E4884F86F6982C8F4D51EA3E54AAE90A88E5`, closure `24676B5E148E545BFF3339187C651791C2BC47273452F4705802AC515B95C06D`, and restoration receipt `005115225A5FED24894FF423C6B51B0762B1584924C2E88CE63C6C3E2840B74E`.

The current operation statically publishes the validated evidence, incorporates the reviewed publication guard, and makes the authority test state-independent without altering runtime law. The exact next action afterward is one separately authorized static scientific adjudication. Do not rerun the consumed full-information command. Because the full result collapsed, neither binding-2 deletion control is authorized or eligible. Preserve both as reserved-unconsumed. Cross-binding replication, general two-parent necessity, transfer, general catalytic inference, task advantage, superiority, SOTA, broader or restart-persistent HoloState, Deep, and automatic promotion remain locked.
