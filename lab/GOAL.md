...
**Next exact action:** Publish the Attempt-2 repair and execute the already authorized `holostate-v1-warm-trajectory-related-task-evaluation-v1-attempt-2` exactly once with a fresh authority bound to that commit. General catalytic inference, transfer, restart persistence, superiority, SOTA, and automatic promotion remain locked.
