...
**Current exact action:** follow the single active cursor at the top of `TASKS.md`: `OFFLINE_ADJUDICATE_COMPLETELY_PRESERVED_NEO_EXP_0081`. Every later next-action statement in this file is a historical boundary record and has no current authority.
