...
**Current exact action:** follow the single active cursor at the top of `TASKS.md`: `EXECUTE_NEO_EXP_0081_AGENTS_A1_MMA_OPEN_B_BOUNDARY_ONCE`. Every later next-action statement in this file is a historical boundary record and has no current authority.
