...
## Checkpoint 2: Preserve terminal balanced opaque CK0 full-information evidence

`balanced-opaque-relational-carrier-v1` remains implemented and statically bound from protected starting main `9eb024d9f664b5592997aac90081d083e75adbd1`. Reserved full-information run `ck0-balanced-v1-full-r1` executed exactly once from protected main `38abb3ca54f16083206f33b10103b3311c1eafd5` with the exact frozen model, binary, carrier, schemas, seeds, one slot, one sidecar epoch, and unchanged six-request lifecycle. No retry, repair, deletion control, disclosure, Deep request, or promotion occurred.

Admission verified exact protected refs, clean stable/candidate custody, exact model/binary/carrier/schema identities, evaluator lock, historical CIB0 a1-a6 and CK0 a1-a6 rehashes, ignored private commitments, zero tracked-secret matches, healthy sole stable PID `20388`, free port 9494, and an unconsumed reservation. Sidecar PID `10372` became ready in 29.687 seconds. All six requests completed and passed cache admission; both normalized parent supports had cardinality five, transform operator `refine` placed the private singleton first, extraction selected it, and private public scoring passed 5 / 5.

Classification is `BALANCED_OPAQUE_RELATIONAL_VISIBLE`. Restoration, cleanup, zero-lease accounting, stable/candidate custody, historical custody, sidecar retirement, and port release passed. Manifest, result, and closure hashes are `A129BBD9BA9DEF0842144178B94A0269F66022EF82DB60D517CDD0C423CC2E1D`, `B57FE3598A03F7CBB2765F77CE702293F72BBF900424F9592D719CF02DA458F8`, and `FE918337A82C7D9D2C59DE56514D284C736A239226F03C91E8025811E92E8DDA`. Preserve narrow non-production `BALANCED_OPAQUE_RELATIONAL_FULL_INFORMATION_VISIBLE`; it establishes only that this one frozen full-information process recovered the private singleton and restored the carrier. It establishes no new parent-dependence or bilateral claim; the historical frozen-carrier Branch-A status is merely preserved. No deletion control is authorized automatically. Only a later separately authorized operation may consider `ck0-balanced-v1-delete-a-r1`; transfer, general catalytic-inference, advantage, superiority, SOTA, persistence, Deep, and promotion claims remain locked.
