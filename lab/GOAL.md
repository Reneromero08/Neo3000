...
## Checkpoint 2: Publish visible binding-1 rank-head v2 evidence and prepare binding-2

Run `ck0-balanced-v2-rank-head-b1-full-r3` completed exactly once from protected main `358c0e2e86136e47647a83cf60e75a6c1078a2fe` as `BALANCED_OPAQUE_RANK_HEAD_V2_VISIBLE`. All six logical stages passed; five model requests and five leases completed at maximum concurrency one; controller extraction issued no model request, froze transform rank zero before private mapping, selected the private singleton, and scored `5/5`; restoration and cleanup passed with zero active leases.

Authority receipt `ABEEBD217119FC49059EEEECBD418867D6C509C44EA066A9E0A3613241332D7C`, manifest `C7B4BFFF37C77833541BCAA65E43180C69EB073D73368E11BDF81231DDC8254E`, result `A4CFEB142F5E1CE538B9724D3C8ED9215B6E2351C6EEC2AD35EE79F01C74AA32`, and closure `E43CFB0505F316AF877712C31B82D8B73BAD379057A38119B2CC911456BF6BA7` remain byte-identical to verified terminal archive bundle `9566F5D1CF9797496ACB9F4716CE68FBDAE0CE5974E90CEE1F6CAA1A66941349`.

Canonical split experiment record `neo-exp-0040` is published at `lab/results.jsonl:53`. Its exact canonical line SHA-256 is `0B167E49C9CA83BD57893B792CA729E0F33F154E27B0CEDD4B172110FCB75C16`. The publication binds the receipt, raw evidence, archive, authority schemas, run design, 18-file implementation, transform and deterministic extraction commitments, restoration, token evidence, and advisory resource boundary while disclosing no private aliases, ranking contents, maps, roots, run keys, raw authority, or cross-binding correspondence.

Binding-2 remains `ck0-balanced-v2-rank-head-b2-full-r1`, unexecuted and not automatically authorized. Its future authority must bind this synchronized committed publication and the canonical `neo-exp-0040` record SHA-256. End-to-end cross-binding replication, binding-2 parent dependence, causal replication, general catalytic inference, task advantage, superiority, SOTA, transfer, Deep, and automatic promotion remain locked.

**Next exact action:** `Separately authorize ck0-balanced-v2-rank-head-b2-full-r1 with a fresh external authority ID bound to the exact publication commit and canonical record SHA-256 0B167E49C9CA83BD57893B792CA729E0F33F154E27B0CEDD4B172110FCB75C16.`
