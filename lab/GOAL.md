...
## Checkpoint 2: Preserve terminal balanced opaque CK0 Branch-A deletion evidence

`balanced-opaque-relational-carrier-v1` remains statically frozen, and full-information run `ck0-balanced-v1-full-r1` remains terminally visible and exact. Reserved Branch-A deletion run `ck0-balanced-v1-delete-a-r1` executed exactly once from protected main `ea757e7afb4ddf832ee7e9e050ac03bc34c2c065` with the exact frozen model, binary, carrier, schemas, seeds, one slot, one sidecar epoch, and six-request lifecycle. No retry, repair, Branch-B control, disclosure, Deep request, or promotion occurred.

Admission verified exact protected refs, clean stable/candidate custody, exact model/binary/carrier/schema identities, evaluator lock, historical CIB0 a1-a6 and CK0 a1-a6 rehashes, exact full-information evidence, ignored private commitments, zero tracked-secret matches, healthy sole stable PID `20388`, free port 9494, and an unconsumed delete-A reservation. Sidecar PID `15156` became ready in 25.609 seconds. All six requests completed and passed cache admission; both complete parent artifacts were constructed and privately verified with support cardinality five.

The transform received only the exact parent-0 commitment receipt and complete unchanged parent-1 opaque relation. Operator `refine` did not rank the private singleton first; extraction did not select it and privately scored 3 / 5. Dedicated classification is `PARENT_A_INFORMATION_DEPENDENCE_SUPPORTED`. Restoration, cleanup, zero-lease accounting, stable/candidate custody, historical and full-information custody, sidecar retirement, and port release passed. Manifest, result, and closure hashes are `03508F7AE5E5F4A812C43F02FD31A3EE4009530B1CB17E61056213AE1079E74E`, `7AE2578A6D48831B5335CE2826424EA375EB169A218502B404BD031507635846`, and `4A2DD55ECC2DD03AE272F08FEB611F97E714EB587A28BD0660673E116286C873`.

Support only non-production `BRANCH_A_INFORMATION_DEPENDENCE_SUPPORTED_ON_BALANCED_OPAQUE_CARRIER`: under the frozen balanced opaque carrier, withholding Branch-A informative content prevented reproduction of the visible full-information singleton resolution. The full-information status and historical frozen-carrier Branch-A result remain separate and unchanged. Branch-B information dependence, bilateral dependence, general two-parent necessity, transfer, general catalytic inference, advantage, superiority, SOTA, broader/restart persistence, Deep, and promotion remain locked.

The exact next action is a separately authorized static publication of the validated bounded delete-A evidence. `ck0-balanced-v1-delete-b-r1` remains unauthorized and unconsumed; no further live action is authorized.
