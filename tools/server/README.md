...
| `--cache-ram-root-device, --no-cache-ram-root-device` | keep RAM-root tensor state in device buffers for faster save and restore (default: disabled)<br/>(env: LLAMA_ARG_CACHE_RAM_ROOT_DEVICE) |
