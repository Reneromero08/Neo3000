...
def test_ram_root_uses_full_polymorphic_host_sequence_state():
    ...
    assert save.count("LLAMA_STATE_SEQ_FLAGS_NONE") >= 4
    assert restore.count("LLAMA_STATE_SEQ_FLAGS_NONE") >= 2
